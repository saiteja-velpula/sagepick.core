...
class TMDBClient:
    ...
    def _transform_list_response(self, response_data: Dict[str, Any]) -> MovieListResponse:
    ...
    async def discover_movies(self, search_params: MovieSearchParams) -> MovieListResponse:
